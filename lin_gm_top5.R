...
pmp_all_modes = function(boot_vec, xymat, kmax , n, keep_cons = FALSE){
...
bootstrap_pmp_all = function(bootrep, xymat, kmax, keep_cons = FALSE) {
  ...
  pmp_all = t(apply(boot_seeds, 2, pmp_all_modes, xymat, kmax, n, keep_cons))
...
# load the data file 
data_dir = "C:/Users/shudi32/Desktop"
setwd(data_dir)
